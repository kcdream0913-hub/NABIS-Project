...
| Note | — | These two rows are the BL-NAV-01 findings the hub labeled "D-051/D-052" in its paste block; renumbered to D-054/D-055 here because D-051–D-053 were already committed for BL-MSG-05 (attachments) at `c636a44`. Decision numbering is owned in this file, allocated after the current max, never taken from a hub label. |
