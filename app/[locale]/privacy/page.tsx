...
const SECTIONS: { h: string; b: string }[] = [
  ...
  { h: "Where it's processed.", b: "Our servers and providers are in the United States. If you use Sangamline from Nepal, your information will be transferred to and processed in the United States, where privacy laws differ from Nepal's. We ask for your explicit consent to this transfer at signup." },
  { h: "Who we share it with.", b: "Providers that host and run our infrastructure ([Vercel — hosting], [Supabase — database/storage], [analytics — TBD]) under contracts limiting their use of your data; authorities where legally required; and a successor entity if Sangamline is reorganized (with notice)." },
  ...
  { h: "Age.", b: "Sangamline is for adults 18+. We don't knowingly collect data from anyone under 18; if we learn we have, we delete it." },
