...
// This renders the route + an honest working-draft notice with the [ENTITY] /
// [DATE] placeholders — not lorem. Fill the clauses once BL-LEGAL-05 is provided.
  ...
  return (
    <article className="mx-auto max-w-2xl">
      ...
      <div className="card mt-4 space-y-3 p-5 text-sm leading-relaxed text-ink">
        ...
        <p className="text-ink-soft">{t("termsIntro", { entity: "[ENTITY]" })}</p>
      </div>
    </article>
  );
}
