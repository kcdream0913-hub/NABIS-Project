...
const SECTIONS: { h: string; b: string }[] = [
  { h: "1. Who we are.", b: 'These terms are an agreement between you and [ENTITY] ("Sangamline," "we," "us"). Contact: [LEGAL_EMAIL].' },
  { h: "2. What Sangamline is — and isn't.", b: 'Sangamline is an early, invite-only pilot of a curated community network that helps professionals and businesses in the United States and Nepal discover and connect with each other. We introduce; we don\'t broker. Sangamline is not a party to any conversation, agreement, service, or transaction between members, makes no guarantee about any member\'s identity, credentials, quality, conduct, or the outcome of any dealing between members, and does not endorse any member. Any arrangement you make with another member is solely between you and them, at your own risk. The pilot is free, experimental, and provided "as is" and "as available"; features may change, break, or be removed, and data may be reset, at any time.' },
  ...
  { h: "4. Verification and badges — what they mean.", b: 'During the pilot, a "Verified" label reflects a light community review by Sangamline (for example, confirming a profile and a basic business signal, or a member reference). It is not an identity check, a background check, a KYC/legal verification, or a credential guarantee, and it is not an endorsement or a recommendation. A "Bridge" label additionally indicates a member set up for cross-border connection; where a regulated profession is involved (e.g., law), we may note a public-registry check, but we do not guarantee its currency. Always exercise your own judgment and do your own due diligence before dealing with anyone. Misrepresenting your verification status, or impersonating another person or business, is prohibited.' },
  { h: "5. No on-platform transactions.", b: "The pilot does not process payments, purchases, bookings, escrow, or fund transfers. Do not send money through Sangamline; there is no mechanism to do so. Any payment or commercial arrangement between members happens off-platform, at your own risk, and outside these terms." },
  { h: "6. No investment, fundraising, or project funding.", b: "Sangamline does not solicit, facilitate, broker, or process any investment, securities offering, loan, donation, grant, or project funding, and nothing on the platform is an offer or solicitation of any of these, or investment, legal, tax, or immigration advice. Do not use the pilot to raise or move capital." },
  { h: "7. Your responsibilities across borders.", b: "You are responsible for complying with the laws that apply to you — including business, tax, licensing, export, sanctions, immigration, and foreign-exchange rules in your own country and in any country you do business with. Sangamline connects people; it does not make cross-border activity lawful for you." },
  { h: "8. Your content.", b: "You keep ownership of what you post. You grant Sangamline a non-exclusive, worldwide, royalty-free license to host, display, and distribute your content for operating and improving the platform. You represent that you have the rights to what you post and that it doesn't violate anyone's rights." },
  ...
  { h: "13. Disclaimers; limitation of liability.", b: "To the maximum extent permitted by law: we disclaim all warranties, express or implied; Sangamline and its people are not liable for any indirect, incidental, special, consequential, or punitive damages, or for the acts, omissions, content, or conduct of any member or third party; and our total liability arising out of the pilot is capped at US $100. Some jurisdictions don't allow certain limitations, so parts of this section may not apply to you." },
  { h: "14. Indemnity.", b: "You will indemnify and hold Sangamline harmless against third-party claims arising from your content, your dealings with other members, or your breach of these terms." },
